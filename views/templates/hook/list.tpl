 ...
 *}
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Slides list' d='Modules.Pwimagebloc.Admin'}
	<span class="panel-heading-action">
		<a id="desc-product-new" class="list-toolbar-btn" href="{$link->getAdminLink('AdminModules')}&configure=pw_imagebloc&addSlide=1">
						...
						<div class="col-md-8">
								...
								{if $slide.is_shared}
									<div>
										<span class="label color_field pull-left" style="background-color:#108510;color:white;margin-top:5px;">
											{l s='Shared slide' d='Modules.Pwimagebloc.Admin'}
										</span>
									</div>
								{/if}
							</h4>
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=pw_imagebloc&id_slide={$slide.id_slide}">
									<i class="icon-edit"></i>
									{l s='Edit' d='Admin.Actions'}
								</a>
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=pw_imagebloc&delete_id_slide={$slide.id_slide}">
